...
However your contact data is organized, it must be aligned with Neotoma's so that it can be included in the database.
Two contact categories:
Publication related contacts such as Authors and Editors, and Contacts for the dataset.

First we will use the matched publication data to match contacts. 

The contacts need to be formatted as
...
matchedContacts <- get_contacts(contact)
