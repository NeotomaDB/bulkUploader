...
neotoma <- readr::read_delim('../data/PAVELA_PUBLIC_arranged.txt', delim="\t")
...
## JESSICA NOTES: formatPubs doesn't work. It looks like lines 70-73 of that function end up rewriting hte title names for PaVeLA. I have commented it out for now, so I can run the formatPubs function. But then I get stuck at the scrape_dois step, where I am getting an error:
  # unused arguments (savefile = "../data/neotomatab.RDS", restore = FALSE)
# This maybe is an rmd/RStudio thing, but I've tried it with both one and two periods in the save pathway and I cannot get it to run. I am frustrated, so I just ended my session here.

load('./R/formatPubs.R') # doesn't work, just copy and paste the function directly from the script
