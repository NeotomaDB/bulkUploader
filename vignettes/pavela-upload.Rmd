...
Note that we need to build the bulkUploader package first.
Do this through the "build" tab, click "install and restart" 
If that doesn't work, you can load the functions manually the following way (change eval=TRUE) in the chunk header
```{r loadFunctions, , eval=FALSE, results='hide', message=FALSE}

funPaths <- list.files(path = "../R", full.names = TRUE)
funPaths
sapply(funPaths, FUN=source)
...
JESSICA START HERE with arranging pavela data into 'neotoma_pubs.csv' format
